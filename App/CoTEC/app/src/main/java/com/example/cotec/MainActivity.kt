...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn2.setOnClickListener(){
            ...
            try {
                DB.execSQL("INSERT INTO Continents (Name)\n" +
                        "VALUES\n" +
                        "    ('Asia'),\n" +
                        "    ('Europe'),\n" +
                        "    ('Africa'),\n" +
                        ...
                        "    ('Antarctica'),\n" +
                        "    ('South America');\n")
                DB.execSQL("INSERT INTO Countries (Name,Continent_Name)\n" +
                        "VALUES\n" +
                        "    ('Afghanistan','Asia'),\n" +
                        "    ('Albania','Europe'),\n" +
                        "    ('Algeria','Africa'),\n" +
                        ...
                        "    ('Zambia','Africa'),\n" +
                        "    ('Zimbabwe','Africa');\n")
                DB.execSQL("INSERT INTO CountryLocations (Name,Country_Name)\n" +
                        "VALUES \n" +
                        "    ('Heredia','Costa Rica'),\n" +
                        "    ('Alajuela','Costa Rica'),\n" +
                        "    ('Limón','Costa Rica'),\n" +
                ...
                DB.execSQL("INSERT INTO SanityMeasurements (Id,Name,Description) \n" +
                        "VALUES \n" +
                ...
                DB.execSQL("INSERT INTO EnforcedMeasurements (Country_Name,Measurement_Id,Start_Date,End_Date)\n" +
                        "VALUES\n" +
                ...
                DB.execSQL("INSERT INTO Hospitals (Id,Name,ICU_Capacity,Capacity,Manager_Name,Phone)\n" +
                        "VALUES\n" +
                ...
                DB.execSQL("INSERT INTO Hospital_ICUs (ICU_Patient,Hospital_Id)\n" +
                        "VALUES\n" +
                        "('225225',1),\n" +
                        "('334334',3),\n" +
                        "('554554',3);\n")
                DB.execSQL("INSERT INTO Hospital_Patients (Patient,Hospital_Id)\n" +
                        "VALUES\n" +
                        "('225225',1),\n" +
                        "('334334',4),\n" +
                        "('554554',4);\n" +
                        "\n")
                DB.execSQL("INSERT INTO Medications (Id,Name,Provider)\n" +
                        "VALUES\n" +
                        "(22,'paracetamol','pulpería'),\n" +
                        "(23,'sopita','pulpería'),\n" +
                        "(24,'hierba','farmacia');\n")
                DB.execSQL("INSERT INTO Hospital_Medications (Hospital_Id,Medication_Id)\n" +
                        "VALUES\n" +
                        "(1,22),\n" +
                        "(3,23),\n" +
                        "(4,24);\n")
                DB.execSQL("INSERT INTO Pathologies (Name,Symptoms,Description,Treatment)\n" +
                        "VALUES\n" +
                        "('Ebola','hemorragia','solo en africa','no hay'),\n" +
                        "('Covid','tos','mundial','respirador'),\n" +
                        "('Denge','fiebre','mosquitos','antiinflamatorios');\n")
                DB.execSQL("INSERT INTO Patient_Status (Name)\n" +
                        "VALUES\n" +
                        "('Muerto'),\n" +
                        "('Activo'),\n" +
                        "('Recuperado');\n" +
                        "\n")
                DB.execSQL("INSERT INTO Patients (SSN,First_Name,Last_Name,Hospitalized,ICU,Age,Residence,Country_Birth,Hospital_Id,Status)\n" +
                        "VALUES\n" +
                ...
                DB.execSQL("INSERT INTO Patient_Pathologies (Patient_SSN,Pathology_Name)\n" +
                        "VALUES\n" +
                        "(100001,'Covid'),\n" +
                        "(100002,'Denge'),\n" +
                        "(100000,'Covid');\n")
                DB.execSQL("INSERT INTO Patient_Medications (Patient_SSN,Medication_Id)\n" +
                        "VALUES\n" +
                        "(100001,22),\n" +
                        "(100002,22),\n" +
                        "(100000,24);\n")
                DB.execSQL("INSERT INTO Contacted_Person (SSN,Patient_SSN,First_Name,Last_Name,Address,Email,Age)\n" +
                        "VALUES\n" +
